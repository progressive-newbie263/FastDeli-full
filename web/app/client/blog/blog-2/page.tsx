...
import SocialMedia from '@client/components/SocialMedia';

import { Metadata } from 'next';

export const metadata: Metadata = {
  title: "Giao Đồ Ăn Mọi Lúc, Mọi Nơi Cùng FoodDeli",
  description:
    "Trong nhịp sống bận rộn, FoodDeli mang đến cho bạn sự tiện lợi tuyệt vời khi bạn muốn thưởng thức món ăn yêu thích ngay tại nhà hay nơi làm việc.",
};
    ...
    <div className="bg-white min-h-screen">
      ...
      >
        <section className="p-8 border border-gray-200 w-[450px] md:w-[800px] sm:w-[600px]">
          ...
          <p className="mb-4">
            Trong nhịp sống bận rộn, FoodDeli mang đến cho bạn sự tiện lợi tuyệt vời khi bạn
          ...
          <p>
            Với FoodDeli, bạn có thể tìm thấy hàng ngàn món ăn từ các nhà hàng, quán ăn nổi
          ...
          <p>
            Không chỉ là các món ăn vặt, FoodDeli cung cấp một thực đơn phong phú từ các món ăn
          ...
          <p>
            FoodDeli luôn có những chương trình ưu đãi hấp dẫn, giúp bạn tiết kiệm chi phí mỗi
          ...
          <p>
            FastDeli cam kết giao đồ ăn nhanh chóng, đúng giờ, đảm bảo món ăn vẫn nóng hổi và
            tươi ngon khi bạn nhận được.
          </p>

          <h3 className="text-xl font-semibold mt-6">5. Thanh Toán Linh Hoạt</h3>
          <p>
            FoodDeli hỗ trợ nhiều hình thức thanh toán, từ ví điện tử, thẻ tín dụng cho đến
