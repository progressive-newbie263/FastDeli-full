    ...
    return (
      <AdminLayout title="Chi tiết nhà hàng" subtitle="Đang tải...">
        <div className="bg-white rounded-xl card-shadow p-8 text-center">
          <div className="text-gray-500">Đang tải thông tin nhà hàng...</div>
        </div>
      </AdminLayout>
    );
  }
  ...
  if (!restaurant) {
    return (
      <AdminLayout title="Chi tiết nhà hàng" subtitle="Không tìm thấy">
        <div className="bg-white rounded-xl card-shadow p-8 text-center">
          <div className="text-gray-500 mb-4">Không tìm thấy nhà hàng</div>
          <button
  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div className="hidden md:block bg-white rounded-xl card-shadow p-6">
          <div className="flex flex-wrap gap-3">
            ...
            {restaurant.status === 'active' && (
              <button
                ...
                disabled={isUpdating}
                className="px-6 py-3 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 disabled:bg-gray-300 disabled:cursor-not-allowed font-medium transition-colors flex items-center gap-2"
              >
                <span>⏸</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl card-shadow p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-900">{restaurant.description || 'Chưa có mô tả'}</p>
                </div>

                <div className="pt-4 border-t">
                  <p className="text-sm font-medium text-gray-500 mb-2">📍 Địa chỉ</p>
                  <p className="text-gray-900">{restaurant.address}</p>
                </div>

                <div className="pt-4 border-t">
                  <p className="text-sm font-medium text-gray-500 mb-2">📞 Liên hệ</p>
            ...
            <div className="bg-white rounded-xl card-shadow p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-blue-50 rounded-lg">
                  <p className="text-sm text-gray-600 mb-1">Thời gian giao</p>
                ...
                <div className="p-4 bg-purple-50 rounded-lg">
                  <p className="text-sm text-gray-600 mb-1">Đơn tối thiểu</p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl card-shadow p-6">
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-sm font-medium text-gray-500 mb-1">ID nhà hàng</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {foods.map((food) => (
                ...
                >
                  ...
                  />
                  <div className="p-3">
                    <h4 className="font-semibold text-gray-900 mb-1 truncate" title={food.food_name}>
                      {food.food_name}
                    </h4>
        ...
        <div className="md:hidden bg-white rounded-xl card-shadow p-4">
            ...
            {restaurant.status === 'pending' && (
              <>
                ...
                <button
                  onClick={() => setShowRejectModal(true)}
                  disabled={isUpdating}
                  className="w-full px-4 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 disabled:bg-gray-300 disabled:cursor-not-allowed font-medium transition-colors"
                >
                  ✗ Từ chối nhà hàng
                </button>
              </>
