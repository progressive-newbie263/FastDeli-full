      ...
      <footer className="bg-gray-200 text-gray-800 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-5 gap-7 sm:flex-col text-center md:text-left">
          ...
          <div className="min-h-[200px] max-w-40">
            ...
            <ul className="text-sm space-y-2">
              <li><Link href="/food-service/landing" className="hover:underline">FoodDeli</Link></li>
              <li><Link href="/delivery-service" className="hover:underline">ShipDeli</Link></li>
              <li><Link href="/bike-service" className="hover:underline">BikeDeli</Link></li>
            </ul>
          </div>
