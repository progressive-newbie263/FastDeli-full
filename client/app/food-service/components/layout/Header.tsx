    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-white shadow-md">
      <div className="w-full max-w-screen-2xl mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <nav className="hidden [@media(min-width:850px)]:flex items-center space-x-6">
          ...
          */}
          <Link href="/food-service" className={getLinkClass('/food-service', true)}>Trang chủ</Link>

          <Link href="/food-service/restaurants" className={getLinkClass('/food-service/restaurants')}>Nhà hàng</Link>
          <Link href="/food-service/coupons" className={getLinkClass('/food-service/coupons')}>Khuyến mãi</Link>
          <Link href="/food-service/orders" className={getLinkClass('/food-service/orders')}>Đơn hàng</Link>
        </nav>
